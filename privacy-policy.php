...
<div class="container mt-5 mb-5">
  ...
  <p>
    At pantryo.in, accessible from https://pantryo.in, one of our main
    priorities is the privacy of our visitors. This Privacy Policy document
    contains types of information that is collected and recorded by pantryo.in
    and how we use it.
  </p>
  ...
  <p>
    ...
    and/or collect in pantryo.in. This policy is not applicable to any
  ...
  <p>
    pantryo.in follows a standard procedure of using log files. These files log
  ...
  <P
    ...
    advertising partners of pantryo.in.</P
  >

  <p>
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on pantryo.in, which are sent directly to users'
  ...
  <p>
    Note that pantryo.in has no access to or control over these cookies that are
  ...
  <p>
    pantryo.in's Privacy Policy does not apply to other advertisers or websites.
  ...
  <p>
    pantryo.in does not knowingly collect any Personal Identifiable Information
