<div class="container mt-5">
    <div class="d-flex justify-content-center align-items-center banner-section">
        ...
        <lottie-player src="https://assets10.lottiefiles.com/packages/lf20_fqp4fqql.json" background="transparent" speed="1" class="mid-banner-lottie" loop autoplay></lottie-player>
